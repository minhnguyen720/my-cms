...
const getTotalProject = async () => {
  ...
  try {
    const at = cookieJar.get("at")?.value;
    const res = await fetch("http://localhost:4000/project/total", {
      method: "GET",
      headers: {
        Accept: "*/*",
        Authorization: `Bearer ${at}`,
